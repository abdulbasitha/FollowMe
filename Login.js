                ...
                <View style={styles.registersection}>
                    ...
                    <View style={styles.cardview}>
                        <View style={styles.elememts}>
                            <TextInput style={styles.TextInput} placeholder="Name" autoFocus onChangeText={(name) => this.setState({name})}/>
                        </View>
                        <View style={styles.elememts}>
                        ...
                        <View style={styles.elememts}>
                            <TextInput style={styles.TextInput} placeholder="Your Bus Number" onChangeText={(busno) => this.setState({busno})}/>
                        </View>
                        <View style={styles.elememts}>
